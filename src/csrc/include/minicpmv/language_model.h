...
struct LanguageModelConfig {
    ...
    std::string embed_weight_name{"model.language_model.embed_tokens.weight"};
    std::string final_norm_weight_name{"model.language_model.norm.weight"};
    std::string lm_head_weight_name;
    bool attention_qk_norm_gate{true};
};
